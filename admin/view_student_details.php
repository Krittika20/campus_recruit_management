                                    ...
                                    <div class="table-responsive">
                                      <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for Skills..">
                                        <table class="table table-striped table-bordered table-hover" id="dataTables">
                                            ...
                                            $sql="SELECT ID,NAME,EMAIL,PHONE,SKILLS,PROJECTS from users";
                                            $result=$conn-> query($sql);
                                            if($result-> num_rows>0)
                                            {
                                                while($row=$result-> fetch_assoc()){
                                                    echo "<tr><td>".$row["ID"]."</td><td>".$row["NAME"]."</td><td>".$row["EMAIL"]."</td><td>".$row["PHONE"]."</td><td>".$row["SKILLS"]."</td><td>".$row["PROJECTS"]."</td><tr>";
                                                }
                                                echo "</table>";
                                            }
                                            else{
