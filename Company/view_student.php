                                    ...
                                    <div class="table-responsive">
                                      <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for skills..">
                                        <table class="table table-striped table-bordered table-hover" id="dataTables">
                                            ...
                                            $sql="SELECT SNAME,SEID,SPH,SSK,SPR from sprofile";
                                            $result=$conn-> query($sql);
                                            if($result-> num_rows>0)
                                            {
                                                while($row=$result-> fetch_assoc()){
                                                    echo "<tr><td>". $row["SNAME"]."</td><td>".$row["SEID"]."</td><td>".$row["SPH"]."</td><td>".$row["SSK"]."</td><td>".$row["SPR"]."</td><tr>";
                                                }
                                                echo "</table>";
                                            }
                                            else{
                                            ...
                                            <!-- <tbody>
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td class="center"><i class="fa fa-download" aria-hidden="true"></i></td>
                                                </tr>
